...
# variant_ID, type, length, chr, pos, ref, alt, cadd_score, cadd_interpr, dbsnp_id, dbsnp_url, UCSC_url, ensembl_url, clinvar_url
# type :SNV, ins or del
#Length
# CADD_score / interpr
...
if (exists("start_time")) {
  ...
  print(paste("Execution duration in seconds:", duration_seconds))
} else {
  print("Set 'start_time <- Sys.time()' at the top of your script to measure duration.")
}
