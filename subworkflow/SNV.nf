...
workflow SNV {
	...
	main :
		...
		bcf_to_vcf(GLnexus_cli.out, assembly, batch, run)
                ...
                Hail_sample_QC(bcf_to_vcf.out.vcf, assembly,reference,reference_index)
                Hail_variant_QC(Hail_sample_QC.out.vcf_sample_filtered, Hail_sample_QC.out.filtered_sample_sex, assembly, reference, reference_index)
