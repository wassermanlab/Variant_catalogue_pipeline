...
process SNV_data_organization {
	...
	publishDir "$params.outdir_pop/${assembly}/${run}/Oracle_table/genomic_ibvl_frequencies/", mode: 'copy', pattern: "genomic_ibvl_frequencies_*"
        ...
        publishDir "$params.outdir_pop/${assembly}/${run}/Oracle_table/variant_annotations/", mode: 'copy', pattern: "variant_annotations_*"
	...
	Rscript ../../../modules/SNV_data_organization.R $assembly gnomad_frequency_table_\${chr}.tsv ${SNV_vcf} \${vcf_name}_\${chr}_SNV_annotation_table_merged_nohash.tsv $sex_table $run
	"""
}
