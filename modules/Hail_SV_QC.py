...
#vcf_path = '/mnt/scratch/SILENT/Act3/Processed/Individual/GRCh37/Batch_DryRun_alpha/Version_0.0.1/SV/'
#hl.import_vcf(os.path.join(vcf_path,'SV_Version_0.0.1.vcf.gz'),
#              array_elements_required=False, force_bgz=True).write('SV_vcf.mt', overwrite=True)
